...
This project is indexed by GitNexus as **subswap** (1569 symbols, 4105 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
