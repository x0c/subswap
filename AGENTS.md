...
This project is indexed by GitNexus as **subswap** (1551 symbols, 4043 relationships, 134 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
