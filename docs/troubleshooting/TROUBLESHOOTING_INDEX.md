...
| 文档 | 排查场景 |
|---|---|
| [2026-07-09 Codex 用量 401 但 CLI 能正常用](2026-07-09-codex-quota-401-despite-working-cli.md) | Codex 账号明明在正常对话、`subswap` 却显示该账号用量 `401 auth failed`；排查「账号是不是真失效」还是「codex-cli 没把刷新后的 token 落盘」时查此，别急着让用户重新登录 |
